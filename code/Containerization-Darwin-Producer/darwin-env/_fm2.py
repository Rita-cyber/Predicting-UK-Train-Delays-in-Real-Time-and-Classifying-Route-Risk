...
# Generated 2025-07-19 14:40:48.839167 by PyXB version 1.2.6 using Python 3.9.23.final.0
...
class ScheduleFormations (pyxb.binding.basis.complexTypeDefinition):
    ...
    __rid._DeclarationLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 31, 2)
    __rid._UseLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 31, 2)
...
class Formation (pyxb.binding.basis.complexTypeDefinition):
    ...
    __fid._DeclarationLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 48, 2)
    __fid._UseLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 48, 2)
    ...
    __src._DeclarationLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 53, 2)
    __src._UseLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 53, 2)
    ...
    __srcInst._DeclarationLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 58, 2)
    __srcInst._UseLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 58, 2)
...
class CoachData (pyxb.binding.basis.complexTypeDefinition):
    ...
    __coachNumber._DeclarationLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 87, 2)
    __coachNumber._UseLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 87, 2)
    ...
    __coachClass._DeclarationLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 92, 2)
    __coachClass._UseLocation = pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 92, 2)
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CoachList._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'coach')), pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 69, 3))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 25, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ScheduleFormations._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'formation')), pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(Formation._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'coaches')), pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 42, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 81, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CoachData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'toilet')), pyxb.utils.utility.Location('/workspaces/Predicting-UK-Train-Delays-in-Real-Time-and-Classifying-Route-Risk/code/stomp-client-extraction/darwin-env/ppv16/rttiPPTFormations_v2.xsd', 81, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
